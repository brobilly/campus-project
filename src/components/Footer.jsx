...
const Footer = () => {
  ...
  <div className="grid gap-6 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
    ...
    <div className="space-y-2 text-sm">
      <p className="text-base font-bold tracking-wide text-gray-900 dark:text-white">Contacts</p>
      <div className="flex">
        <p className="mr-1 text-gray-800 dark:text-white ">Phone: +6285161401414</p>
      </div>
      <div className="flex">
        <p className="mr-1 text-gray-800 dark:text-white">Email: daudmanuwu@gmail.com</p>
      </div>
      <div className="flex">
        <p className="mr-1 text-gray-800 dark:text-white">Address: Disini heheh</p>
      </div>
    </div>
    <div>
      <span className="text-base font-bold tracking-wide text-gray-900 dark:text-white">Social</span>
