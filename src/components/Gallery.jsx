...
const Gallery = () => {
  return (
    <div><div className="bg-white dark:bg-gray-800 h-200 py-6  sm:py-8 lg:py-12">
    <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
        ...
        <div className="grid grid-cols-2 gap-4 sm:grid-cols-3 md:gap-6 xl:gap-8">
            <a href="#"
                ...
                <span className="relative ml-4 mb-3 inline-block text-sm text-white md:ml-5 md:text-lg">DJ</span>
            </a>
            ...
            <a href="#"
                ...
                <span className="relative ml-4 mb-3 inline-block text-sm text-white md:ml-5 md:text-lg">Venue</span>
            </a>
            ...
            <a href="#"
                ...
                <span className="relative ml-4 mb-3 inline-block text-sm text-white md:ml-5 md:text-lg">Stage</span>
            </a>
